...
for(let country of countries){
  ...
  let cntrydata={countryName,population,capital,currencyName}
  myCountries.push(cntrydata)
 
// console.log(`countryname${countryName} population${population}  capital ${capital} currencyname${currencyName}`);
...
// above 2cr population country
  

var populalationAbove=myCountries.filter(data=>data.population>200000000).map(cntry=>cntry.countryName).forEach(name=>console.log(name))